		...
		return (
			<Modal className='share_modal'
				...
				<Modal.Content className='share_modal_content'>
					...
					<View className='share_modal_main'>
						...
						<View className='modal_main_email'>
							<View className='modal_main_row'>
